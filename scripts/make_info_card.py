...
HOST = os.environ.get("GH_PROFILE_USER", "PardheevKrishna")
...
ROWS = [
    ...
    ("gap",),
    ("sec", "AI / ML Stack"),
    ("kv", "Basic AI", "Python, OpenCV, Scikit-Learn, Pandas, NumPy"),
    ("kv", "Adv AI", "Fine-Tuning, RAG, Transformers, PyTorch, CNNs"),
